...
$GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['tslib/class.tslib_fe.php']['contentPostProc-output']['bolius_staticdomain'] =
    \Bolius\BoliusStaticdomain\Hooks\Tsfe::class . '->contentPostProc_output';